            ...
            <div class="card-body p-4">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="idCliente" class="form-label">Para o Cliente:</label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="idAdvogado" class="form-label">Advogado Solicitante:</label>
                        <select id="idAdvogado" name="idAdvogado" class="form-select" required>
                            <option value="" disabled selected>Selecione um advogado...</option>
                            <c:forEach var="adv" items="${listaAdvogados}"><option value="${adv.idAdvogado}">${adv.nome}</option></c:forEach>
                        </select>
                    </div>
                </div>

                <div class="mb-3">
                    <label for="idTipoDocumento" class="form-label">Tipo de Documento Solicitado:</label>
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="statusDisplay" value="Pendente" disabled readonly>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="descricao" name="descricao" rows="3" placeholder="Ex: Cópia autenticada do RG para o processo Nº Y..."></textarea>
                </div>
            </div>
